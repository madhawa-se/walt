 ...
 */
function waltons_clark_preprocess_page(&$vars, $hook) {
...
function waltons_clark_webform_grid($element) {
  $rows = array();
 ...
 */
function waltons_clark_breadcrumb($breadcrumb) {
 ...
 */
function waltons_clark_menu_local_tasks() {
  $output = '';
...
/**
 * waltons_clark_preprocess_search_theme_form().
 */
function waltons_clark_preprocess_search_theme_form(&$vars, $hook) {
 ...
 */
function waltons_clark_form_element($element, $value) {
 ...
 */
function waltons_clark_textfield($element) {
 ...
 * Override theme_textfield().
 */
function waltons_clark_webform_email($element) {
  // Add bootstrap classes
  $class = array('form-control');
 ...
 */
function waltons_clark_textarea($element) {
 ...
 */
function waltons_clark_password($element) {
 ...
 */
function waltons_clark_select($element) {
 ...
 */
function waltons_clark_checkbox($element) {
