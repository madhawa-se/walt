...
if ($page) {
  ...
  print '</div>';
  print '<div class="col-xs-12 col-sm-8 staff-page">';    
 ...
 print "<div class='profile'>";
    //print '<div>';
    if ($image_field)
        print "<div class='staff-image'> <a href='$node_url'> $image_field</a></div>";
    ?>
   
 <?php
    //print '<div class="profile-content">'; 
    print "<div class='title'><a href='$node_url' title='$title'>$title</a></div>";
 //if ($position)
    //print "<div class='position'>$position</div>";
  //if ($position)
        //print "<div class='position'>$position</div>";
 
 print "<div class='link-btn'><a href='$node_url' title='View profile, $title'>View profile</a></div>";
    print '</div>';
    //print '</div>';
    //print '</div>';
